...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | DeployX - React.js Admin Dashboard Template"
        description="This is React.js Videos page for DeployX - React.js Tailwind CSS Admin Dashboard Template"
      />
