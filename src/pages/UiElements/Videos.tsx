...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | PalikaOS - React.js Admin Dashboard Template"
        description="This is React.js Videos page for PalikaOS - React.js Tailwind CSS Admin Dashboard Template"
      />
